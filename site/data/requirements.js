...
window.AI4IA_REQUIREMENTS = {
  ...
  rbac: [
    ...
    { assignee: "Application identities", role: "Key Vault Secrets User", scope: "Key Vault", why: "Read application secrets; APIM hop keys remain Container App secrets.", module: "keyvault.bicep" },
