...
window.AI4IA_REQUIREMENTS = {
  ...
  rbac: [
    ...
    { assignee: "id-api", role: "Postgres (Entra token auth)", scope: "Postgres Flexible Server", why: "Passwordless pgvector access as the api identity (no SQL password).", module: "data.bicep" },
  ...
  packages: {
    api: {
      ...
      items: [
        ...
        ["asyncpg", "Postgres + pgvector driver for the legacy memory-migration source and document-chunk fallback, lazily imported"],
