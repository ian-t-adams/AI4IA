...
window.AI4IA_REQUIREMENTS = {
  iac: {
    ...
    modules: [
      ...
      { name: "keyvault.bicep", purpose: "Secrets + configuration baseline: RBAC-mode Key Vault + App Configuration roles; postprovision reconciles the sentinel." },
  ...
  rbac: [
    ...
    { assignee: "OIDC deployment identity", role: "App Configuration Data Owner", scope: "App Configuration store", why: "Provisioning-only postprovision reconciliation of Warm:Sentinel with Entra auth; web/API/proxy receive no write role.", module: "main.bicep / keyvault.bicep / postprovision.ps1" },
