...
window.AI4IA_META = {
  ...
  features: [
    ...
    { name: "Azure OpenAI Voice Live", templateOn: true, observedOn: true, param: "voiceLiveEnabled",
      note: "Live under the owner-approved non-blocking assessment policy; provider assessment coverage remains incomplete." },
    ...
    { name: "WebIQ search and retrieval", templateOn: true, observedOn: true, param: "webSearchEnabled",
      note: "Eleven tools: web/news/image/video search, classic structured answers (including weather), finance, places, sports, Sonic, autosuggest and browsing. Bounded, metered and governed; extra endpoint access is subject to WebIQ entitlement. Observed on refers to the WebIQ gate, not deployment or entitlement of every expanded capability." },
