...
_TOOL_VERBS: dict[str, tuple[str, str]] = {
    ...
    "classic_search": ("Searching structured web answers", "Searched structured web answers"),
    "finance_search": ("Looking up financial data", "Looked up financial data"),
    "places_search": ("Looking up places", "Looked up places"),
    "sports_search": ("Looking up sports", "Looked up sports"),
    "sonic_search": ("Searching with Sonic", "Searched with Sonic"),
    "web_autosuggest": ("Finding query suggestions", "Found query suggestions"),
